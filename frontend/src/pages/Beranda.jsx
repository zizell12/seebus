  ...
  const keunggulan = [
    {
      ...
      judul: t.keunggulan.item1Judul,
      desk: t.keunggulan.item1Desk,
    },
    {
      icon: <Route className="w-5 h-5 text-white" />,
      judul: t.keunggulan.item2Judul,
      desk: t.keunggulan.item2Desk,
    },
    {
      icon: <ShieldCheck className="w-5 h-5 text-white" />,
      judul: t.keunggulan.item3Judul,
      desk: t.keunggulan.item3Desk,
    },
  ]
  const langkah = [
    {
      icon: <Search className="w-5 h-5 text-brand-red" />,
      judul: t.caraKerja.langkah1Judul,
      desk: t.caraKerja.langkah1Desk,
    },
    {
      icon: <ListChecks className="w-5 h-5 text-brand-red" />,
      judul: t.caraKerja.langkah2Judul,
      desk: t.caraKerja.langkah2Desk,
    },
    {
      icon: <CreditCard className="w-5 h-5 text-brand-red" />,
      judul: t.caraKerja.langkah3Judul,
      desk: t.caraKerja.langkah3Desk,
    },
  ]
  return (
    <div>
      ...
      <section className="max-w-7xl mx-auto px-4 md:px-6 py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {keunggulan.map((k) => (
            <div key={k.judul} className="card text-center">
              <div className="w-10 h-10 rounded-lg bg-navy-900 flex items-center justify-center mb-4 mx-auto">
                {k.icon}
              </div>
      ...
      <section className="bg-gray-50 py-16">
        <div className="max-w-7xl mx-auto px-4 md:px-6">
          ...
          <p className="text-center text-gray-500 text-sm mb-10">{t.wisata.deskripsi}</p>
